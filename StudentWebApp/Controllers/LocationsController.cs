...
namespace TechElevator.Controllers
{
    public class LocationsController : Controller
    {
        ...
        public LocationsController(TechElevatorContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Address,City,State,Zip")] Location location)
        {
            if (id != location.Id)
            {
                return NotFound();
